...
public class ShopPanel extends JPanel {
	...
	public JButton rentCostumesButton, addCustomerButton, addCostumeButton;
	public JTextField customerTextField, priceTextField, costumeTextField;
	...
	private ArrayList<Costume> getAllCostumes() {
		...
		String[] starWarsCostumes = { "Princess Leia", "Jedi", "Jabba", "Jar Jar", "Darth Vader", "Yoda",
		...
		String[] superHeroesCostumes = { "Wonder Woman", "Deadpool", "Batman", "Hulk", "SpiderMan", "Black Widow",
				"Harley Quinn" };
	...
	private Component generateCustomerComboBox() {
		...
		comboBoxItems.add(new Customer("Jan Kowalski"));
		comboBoxItems.add(new Customer("Karolina Miller"));
		comboBoxItems.add(new Customer("Karol Watroba"));
		comboBoxItems.add(new Customer("Piotr Nowak"));
